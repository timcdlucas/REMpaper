...
p7101 = pi**-1 * (integrate(m7101[0][0], m7101[0][1:]) + integrate(m7101[1][0], m7101[1][1:]) + integrate(m7101[2][0], m7101[2][1:]) + integrate(m7101[3][0], m7101[3][1:]) + integrate(m7101[4][0], m7101[4][1:]) ).simplify()
